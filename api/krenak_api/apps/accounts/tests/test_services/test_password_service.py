...
from krenak_api.apps.accounts.exceptions import (
    InvalidPasswordError,
    InvalidResetPasswordSignatureError,
    WrongPasswordError,
)
from krenak_api.apps.accounts.models import UserAccount
from krenak_api.apps.accounts.services.password import PasswordService


PASSWORD_SERVICE_PATH = "krenak_api.apps.accounts.services.password.PasswordService"  # nosec
