...
LOGIN_SERIALIZER_PATH = "krenak_api.apps.accounts.api.v1.serializers.login.LoginSerializer"
...
def test_login_api_success(user_account, unauthorized_api_client, mocker):
    ...
    mocked_login = mocker.patch("krenak_api.apps.accounts.services.login.LoginService.login", return_value=mocked_response)
